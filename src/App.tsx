...
const buildCurrentUserCommentProfile = (): PostProfile | null => {
  ...
  const metadataDisplayName = typeof metadata.name === 'string' ? metadata.name.trim() : ''
