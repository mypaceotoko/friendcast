...
const [composeCustomAudienceIds, setComposeCustomAudienceIds] = useState<string[]>([])
...
const goToScreen = (nextScreen: Screen) => {
  if (nextScreen === 'compose') window.scrollTo(0, 0)
