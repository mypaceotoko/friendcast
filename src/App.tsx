...
const ENABLE_PROFILE_FOLLOW_LISTS = false
...
const [, setProfileFollowingUsers] = useState<Profile[]>([])
const [, setProfileFollowerUsers] = useState<Profile[]>([])
