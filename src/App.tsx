...
const activityIcon = (item: ActivityItem) => item.type === 'comment' ? (item.commentType === 'voice' ? '🎙️' : '💬') : item.type === 'like' ? '❤️' : item.type === 'repost' ? '🔁' : item.type === 'follow' ? '👤' : '✨'
