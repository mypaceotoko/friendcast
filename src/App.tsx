...
const useInviteCode = async (rawCode?: string) => {
  ...
  setIsInviteUsing(true); setInviteActionError(''); setInviteActionMessage(''); setInviteSuccessNotice('')
