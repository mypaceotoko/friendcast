...
type Screen = 'home' | 'compose' | 'detail' | 'postDetail' | 'profile' | 'search' | 'settings'
...
const goToPostDetail = async (postId: string, sourceScreen: Screen = screen) => {
...
const goBackFromPostDetail = () => {
  setScreen(previousScreen === 'postDetail' ? 'home' : previousScreen)
...
const toggleCommentsPanel = async (postId: string) => {
  if (screen !== 'postDetail') return void goToPostDetail(postId)
